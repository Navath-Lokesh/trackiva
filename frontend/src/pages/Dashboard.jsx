...
export default function Dashboard() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white overflow-x-hidden pt-4 sm:pt-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow border border-gray-700">
            ...
            <div className="w-full bg-gray-700 h-2 rounded mt-2">
              <div className="bg-green-400 h-2 rounded" style={{ width: `${stats.todayPercentage}%` }}></div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow border border-gray-700">
            ...
            <div className="w-full bg-gray-700 h-2 rounded mt-2">
              <div className="bg-blue-400 h-2 rounded" style={{ width: `${stats.weeklyPercentage || 0}%` }}></div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow border border-gray-700">
            ...
            <div className="w-full bg-gray-700 h-2 rounded mt-2">
              <div className="bg-orange-400 h-2 rounded" style={{ width: `${stats.monthlyPercentage || 0}%` }}></div>
            </div>
          </div>
